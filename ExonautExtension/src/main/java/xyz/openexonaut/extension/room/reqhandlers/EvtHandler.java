    ...
    public void handleClientRequest(User sender, ISFSObject params) {
        ...
        if (params.containsKey("msgType")) {
            switch (params.getInt("msgType")) {
                ...
                case 28: // EVT_SEND_FUEL_CONSUMED - SendFuelConsumed - sent when starting to
                    // recover fuel
                    break;

                    // TODO: ids which are never sent but have receipt code (probably server-sent or
                    // unused)
                ...
                case 101: // EVT_SEND_START_GAME - not needed: minor GUI string only which is also
                    // set by EVT_TIME_UPDATE
