...
public class ExoBullet {
    ...
    public final float normalizedVelocityX;
    public final float normalizedVelocityY;
    ...
    public ExoBullet(
        ...
        this.normalizedVelocityX = (float) Math.cos(angle);
        this.normalizedVelocityY = (float) Math.sin(angle);
        this.damage = damage;
        this.player = player;
